...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tag.latitude'
        db.add_column('panappticon_tag', 'latitude', self.gf('django.db.models.fields.FloatField')(null=True), keep_default=False)

        # Adding field 'Tag.longitude'
        db.add_column('panappticon_tag', 'longitude', self.gf('django.db.models.fields.FloatField')(null=True), keep_default=False)

        # Adding field 'Session.latitude'
        db.add_column('panappticon_session', 'latitude', self.gf('django.db.models.fields.FloatField')(null=True), keep_default=False)

        # Adding field 'Session.longitude'
        db.add_column('panappticon_session', 'longitude', self.gf('django.db.models.fields.FloatField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tag.latitude'
        db.delete_column('panappticon_tag', 'latitude')

        # Deleting field 'Tag.longitude'
        db.delete_column('panappticon_tag', 'longitude')

        # Deleting field 'Session.latitude'
        db.delete_column('panappticon_session', 'latitude')

        # Deleting field 'Session.longitude'
        db.delete_column('panappticon_session', 'longitude')
