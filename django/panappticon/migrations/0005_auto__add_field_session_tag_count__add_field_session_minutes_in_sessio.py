...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Session.tag_count'
        db.add_column('panappticon_session', 'tag_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Session.minutes_in_session'
        db.add_column('panappticon_session', 'minutes_in_session', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Session.tag_count'
        db.delete_column('panappticon_session', 'tag_count')

        # Deleting field 'Session.minutes_in_session'
        db.delete_column('panappticon_session', 'minutes_in_session')
