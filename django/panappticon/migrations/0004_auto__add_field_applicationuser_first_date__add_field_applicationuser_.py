...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApplicationUser.first_date'
        db.add_column('panappticon_applicationuser', 'first_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2010, 10, 31), blank=True), keep_default=False)

        # Adding field 'ApplicationUser.last_date'
        db.add_column('panappticon_applicationuser', 'last_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2010, 10, 31), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ApplicationUser.first_date'
        db.delete_column('panappticon_applicationuser', 'first_date')

        # Deleting field 'ApplicationUser.last_date'
        db.delete_column('panappticon_applicationuser', 'last_date')
    ...
    models = {
        ...
        'panappticon.applicationuser': {
            ...
            'screenshot_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
