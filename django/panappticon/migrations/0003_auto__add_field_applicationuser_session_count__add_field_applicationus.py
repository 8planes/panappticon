...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApplicationUser.session_count'
        db.add_column('panappticon_applicationuser', 'session_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ApplicationUser.session_count'
        db.delete_column('panappticon_applicationuser', 'session_count')
