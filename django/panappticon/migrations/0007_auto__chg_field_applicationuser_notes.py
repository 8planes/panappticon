...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ApplicationUser.notes'
        db.alter_column('panappticon_applicationuser', 'notes', self.gf('django.db.models.fields.TextField')(max_length=4095))


    def backwards(self, orm):
        
        # Changing field 'ApplicationUser.notes'
        db.alter_column('panappticon_applicationuser', 'notes', self.gf('django.db.models.fields.CharField')(max_length=4095))
